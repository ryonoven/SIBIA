                    ...
                    <?php foreach ($bisnis as $row) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" data-toggle="modal" data-target="#modalUbah" id="btn-edit"class="btn btn-sm btn-warning" style="font-weight: 600;" data-id="<?= $row['id']; ?>" data-ordinat="<?= $row['ordinat']; ?>" data-bis="<?= $row['bis']; ?>" data-lain="<?= $row['lain']; ?>" data-ketiga="<?= $row['ketiga']; ?>" data-hasil="<?= $row['hasil']; ?>" data-apps="<?= $row['apps']; ?>" ><i class="fa fa-edit"></i>&nbsp;Edit</button>
